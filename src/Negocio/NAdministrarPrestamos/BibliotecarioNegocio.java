...
public class BibliotecarioNegocio {
     ...
     * @param id_persona
     */
    public void modificarBibliotecario(int id, int ci, String apellidos, String nombres, String direccion, Date fecha_nacimiento, char sexo, int telefono, int ano_contratacion, int id_persona) {
        m_Bibliotecario.setBibliotecario(id, ci, apellidos, nombres, direccion, fecha_nacimiento, sexo, telefono, ano_contratacion, id_persona);
