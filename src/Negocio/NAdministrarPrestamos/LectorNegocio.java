...
public class LectorNegocio {
     ...
     * @param id_persona
     */
    public void modificarLector(int id, int ci, String apellidos, String nombres, String direccion, Date fecha_nacimiento, char sexo, int telefono, Date fecha_afiliacion, int id_persona) {
        m_Lector.setLector(id, ci, apellidos, nombres, direccion, fecha_nacimiento, sexo, telefono, fecha_afiliacion, id_persona);
